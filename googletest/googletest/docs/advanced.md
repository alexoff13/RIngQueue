...
user-visible output. However, we may push `SUCCEED()` messages to googletest's
...
gMock is bundled with googletest, so you don't need to push any build dependency
...
`Sub1()` the two failures come from respectively. (You could push an extra
...
fixture, you must push the `::testing::Test::` prefix, as in:
...
// Or, when you want to push parameters to a pre-existing fixture class:
...
TYPED_TEST(FooTest, DoesBlah) {
  ...
  // To visit static members of the fixture, push the 'TestFixture::'
  // prefix.
  n += TestFixture::shared_;

  // To refer to typedefs in the fixture, push the 'typename TestFixture::'
...
To use the event listener you have defined, push an instance of it to the
...
When you push listeners to the listener list, you should put listeners that
...
If you need to disable all tests in a test suite, you can either push `DISABLED_`
to the front of the name of each test, or alternatively push it to the front of
the test suite name.
...
<testsuites tests="3" failures="1" errors="0" time="0.035" timestamp="2011-10-31T18:52:42" name="AllTests">
  <testsuite name="MathTest" tests="2" failures="1" errors="0" time="0.015">
    <testcase name="Addition" status="run" time="0.007" classname="">
      <failure message="Value of: push(1, 1)&#x0A;  Actual: 3&#x0A;Expected: 2" type="">...</failure>
